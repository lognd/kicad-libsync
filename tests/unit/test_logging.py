...
from kicad_libsync.logging.filter import BelowLevelFilter
from kicad_libsync.logging.formatter import SimpleFormatter
from kicad_libsync.logging.logger import get_logger
...
def test_below_level_filter_passes_records_below_threshold() -> None:
    # frob:tests src/kicad_libsync/logging/filter.py::BelowLevelFilter.filter kind="unit"
...
def test_simple_formatter_prefixes_level_at_warning_and_above() -> None:
    # frob:tests src/kicad_libsync/logging/formatter.py::SimpleFormatter.format kind="unit"
    fmt = SimpleFormatter()
...
def test_get_logger_returns_a_configured_logger() -> None:
    # frob:tests src/kicad_libsync/logging/logger.py::get_logger kind="unit"
